...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/static/css/history_page/style.css">

</head>
<body>
	<jsp:include page="/WEB-INF/view/utility/header.jsp" />
	<main>
		<div class="container">Lịch sử đọc</div>
			...
			<div class="card-grid">
				<div class="card">
					...
					<div class="card-description">
						<a href="${pageContext.request.contextPath}/story_page" class="card-description-name">
							<h3>Doraemon</h3>
						</a>
						<h5>
