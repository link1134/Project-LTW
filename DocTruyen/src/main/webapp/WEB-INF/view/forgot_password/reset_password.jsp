...
<title>Đọc Truyện || Cài lại mật khẩu</title>
<link rel="icon"
...
<body>
	...
	<main>
		<section class="intro">
			<h2 class="intro__title">Mật khẩu mới</h2>
			<p class="intro__text">Gần xong rồi! Hãy đặt mật khẩu mới cho tài
				khoản của bạn.</p>
			<img
		...
		<form action="${pageContext.request.contextPath}/reset-password"
			...
			<div class="form__group">
				<input type="password" class="form__input"
					placeholder="Xác nhận mật khẩu" name="confirmPassword" required>
			</div>
			<div class="form__group">
				<button class="form__button" type="submit">Cập nhật mật
					khẩu</button>
			</div>
		</form>
	</main>
