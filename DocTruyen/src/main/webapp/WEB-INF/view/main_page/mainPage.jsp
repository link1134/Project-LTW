...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/static/css/main_page/style.css">
...
<body>
    <header class="header_wrapper">
        <nav class="navbar" id="navbar">
            ...
            <!-- Center logo -->
            <div class="nav-logo">
                <img src="https://valvrareteam.net/images/Khong_Co_Tieu_e431_20250703112444.png" alt="Logo">
                <span>DocTruyen</span>
            </div>
            <!-- Right actions -->
            <ul class="nav-right">
                <li><button class="icon-btn"><i class="fas fa-search"></i></button></li>
                <li><button class="icon-btn"><i class="fa fa-bell"></i></button></li>
                <li><img src="https://valvrareteam.net/images/Khong_Co_Tieu_e431_20250703112444.png" class="avatar"
                        alt="User"></li>
            </ul>
        </nav>
    </header>
    <main>
        <div class="big-wrapper">
            <div class="big-carousel">
                <div class="big-card card-no-marker">
                            ...
                            <div>
                                <a href="">
                                    <h2 class="big-card-name">
                                        Trường Hợp Tôi Đi Theo Tiểu Thư Băng Giá Và Bị Cô Ấy Cưng Chiều Đến Mức Phát
                                        Điên!
                                    </h2>
                                </a>
                            </div>
