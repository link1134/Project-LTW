...
public class StoryDAO {
	...
	public int insertStoryFull(Stories stories, String[] genreIDs) {
	    ...
	    try {
	        ...
	        if (affectedRows == 0) throw new SQLException("Lỗi: Không có truyện nào được tạo.");
	...
	public boolean updateStoryFull(Stories stories, String[] genreIDs) {
	    ...
	    try {
	        ...
	        try {
	            if (psStory != null) psStory.close();
	            if (psDelGenre != null) psDelGenre.close();
	            if (psInsGenre != null) psInsGenre.close();
